 <?php
 $action_page="report_district_wise_op.php"; 				//action on submit
 $report_title="District wise OP Visits Summary"; 		//title of the report
 ...
 $chart_name="district_wise_op_bar";	// Name of the chart to be include
 }
