...
<?php
$report_title="Dept wise IP Admissions Summary";
echo "<h3>Report : ".$report_title."</h3>";
echo "<form action=\"report_dept_wise_ip.php\" method=\"post\">"; ?>
<table>
<tr>
<th>From Date</th>
<th>To Date</th>
...
<?php
 ...
 $chart_name="dept_wise_ip_bar";	// Name of the chart to be include
 }
