...
<!DOCTYPE html>
 ...
 <h3>Report : In-Patient Details (Not Discharged)</h3>

<form action="report_patient_details_nd_ip.php" method="post">
...
<?php
 ...
 $query= "SELECT
			...
			WHERE  ((admit_date BETWEEN '".$_POST['from_date']. "' AND '" . $_POST['to_date'] ."') AND (outcome='') AND (visit_type='IP')" . $dept . $unit . $area . $gender . ")";
