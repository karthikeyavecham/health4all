...
<!DOCTYPE html>
 ...
 <h3>Report : In-Patient Details (Admissions)</h3>

<form action="report_patient_icd_details.php" method="post">
<?php require_once "report_classes/table_form_icd.php";?>
</form>
<br>
...
<?php
 ...
 $query= "SELECT
          	patients.patient_id \"pid\", visit_id, admit_id, hosp_file_no, name, mother_name, father_name, place, phone, gender, dob, admit_date, provisional_diagnosis, outcome
			FROM patient_visits
			INNER JOIN patients ON patient_visits.patient_id = patients.patient_id
			INNER JOIN icd_code ON icd_code.icd_code = ('patient_visits.icd_10'.'patient_visit.icd_10_ext')
