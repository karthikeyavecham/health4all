 <?php
 $action_page="report_day_wise_ip.php"; 				//action on submit
 $report_title="Day wise IP Admissions Summary"; 		//title of the report
 ...
 $chart_name="day_wise_ip_line";	// Name of the chart to be include
 }
