<?php
 ...
 while ($record_1 = mysql_fetch_array($result_1)){
	$dataSet->addPoint(new Point("". $arr_m[$record_1['Month']] ." (". $record_1['Year'].")",$record_1['IP']));
	}
	$chart->setDataSet($dataSet);
	$chart->getPlot()->setGraphPadding(new Padding(5, 60, 80, 50));
	$chart->setTitle("Month Wise IP Admissions");
	$chart->render("../images/generated/month_wise_ip_line.png");
...
<body>
	<img alt="Line chart" src="../images/generated/month_wise_ip_line.png" style="border: 1px solid gray;"/>
</body>
</html>