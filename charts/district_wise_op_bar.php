<?php
	...
	$query_1= "SELECT
		  ...
		  WHERE  ((admit_date BETWEEN '".$_POST['from_date']. "' AND '" . $_POST['to_date'] ."') AND (visit_type='OP')" . $dept . ")
          GROUP BY district
		  ORDER BY patients.district_id DESC";
          
 $result_1 = mysql_query($query_1);
 while ($record_1 = mysql_fetch_array($result_1)){
 	$dataSet->addPoint(new Point("" . $record_1['District'] . "",$record_1['OP']));
	}
	$chart->setDataSet($dataSet);
	$chart->getPlot()->setGraphPadding(new Padding(5, 30, 20, 80));

	$chart->setTitle("District Wise OP Visits");
	$chart->render("../images/generated/district_wise_op_bar.png");
?>
...
<body>
	<img alt="Horizontal bars chart"  src="../images/generated/district_wise_op_bar.png" style="border: 1px solid gray;"/>
</body>
</html>
