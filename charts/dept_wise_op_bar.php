<?php
 ...
 while ($record_1 = mysql_fetch_array($result_1)){
	if($record_1['Department']!=""){
 	$dataSet->addPoint(new Point("" . $record_1['Department'] . "",$record_1['OP']));
	}}
	$chart->setDataSet($dataSet);
	$chart->getPlot()->setGraphPadding(new Padding(5, 30, 20, 80));

	$chart->setTitle("Department Wise OP Visits");
	$chart->render("../images/generated/dept_wise_op_bar.png");
?>
...
<body>
	<img alt="Horizontal bars chart"  src="../images/generated/dept_wise_op_bar.png" style="border: 1px solid gray;"/>
</body>
</html>
