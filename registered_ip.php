...
while ($record = mysql_fetch_array($result)){
 ...
 echo "<br/>";
 echo "<input type=\"button\" value=\"Register OP for Another Patient\" style=\"width:200px; height:40px\" onclick=\"window.location = 'outpatient_first.php';\">";
 echo "<br/>"; echo "<br/>";
 echo "<input type=\"button\" value=\"Register IP for Another Patient\" style=\"width:200px; height:40px\" onclick=\"window.location = 'registration_ip.php';\">";
 echo "<br/>";
 echo "<br/>";
