...
<table width="100%">
	...
	<tr>
		...
		<div style="border: 1px solid #B0B0B0; width:100%; height:100%; overflow:auto;">
			...
			<?php
				$query_marital= "SELECT * 
						FROM marital_info 
						WHERE patient_id='".$record['patient_id']."'";
				
				$result_marital = mysql_query($query_marital);
				if(mysql_num_rows($result_marital)!= 0) {
				while($record_marital = mysql_fetch_array($result_marital)){ 
				echo "<table id=\"table-tab\">";
					echo "<tr>";
						echo "<td>Marital Status <b style=\"color:red\">*</b></td>";
						echo "<td><select name=\"marital_status\">";
							echo "<option value=\"\""; if($record_marital['marital_status'] == '') { echo "selected=\"selected\""; } echo ">---Select---</option>";
							echo "<option value=\"married\""; if($record_marital['marital_status'] == 'married') { echo "selected=\"selected\""; } echo ">Married</option>";
							echo "<option value=\"unmaried\""; if($record_marital['marital_status'] == 'unmaried') { echo "selected=\"selected\""; } echo ">Unmaried</option>";
							echo "<option value=\"seperated\""; if($record_marital['marital_status'] == 'seperated') { echo "selected=\"selected\""; } echo ">Seperated</option>";
						echo "</select></td>";
					echo "</tr>";
					echo "<tr>";
						echo "<td>Marital Life(yrs)</td>";
						echo "<td><input type=\"text\" size=\"3\" maxlength=\"3\" name=\"marital_life\" value=\"".$record_marital['marital_life']."\"></td>";
					echo "</tr><tr>";
						echo "<td>Consanguinous</td>";
							$con_yes = ''; 
							$con_no = '';
							if($record_marital['consanguinous']=="yes")
							{
								$con_yes = 'checked="checked"';
							}
							else if($record_marital['consanguinous']=="no")
							{
								$con_no = 'checked="checked"';
							}
						echo "<td><input type=\"radio\" name=\"consanguinous\" value=\"yes\" ".$con_yes." >Yes";
						echo "<input type=\"radio\" name=\"consanguinous\" value=\"no\" ".$con_no.">No</td>";
					echo "</tr>";
				echo "</table>";
				}} 
				else {
