...
<form name="reg" action="registration_ip_trans.php" onsubmit="return validateForm_ip();" method="post">
<table>
	<tr><td></td><td>
		<table width="100%">
			<tr>
	...
	<tr>
		<td style="vertical-align:top; padding-right:0px; padding-top:20px;">
			<table>
				...
				<tr id="gynic_button" hidden><td><input type="button" id="button_6" value="OBG Info" onclick="reveal('div_6','button_6');" style="width:100%;"></td></tr>
				<tr id="diagnostics_button"><td><input type="button" id="button_7" value="Diagnostics" onclick="reveal('div_7','button_7');" style="width:100%;"></td></tr>
				...
				<div id="div_3" style="display:none;" >
					<table width="100%" id="table-tab">
						<tr>
							...
							<td>
								<input type="text" id="vdatepicker" name="admit_date">
							</td>
							<td>Visit/Admit Time *</td>
							<td>
								<input type="text" id="vtimepicker" size="10" name="admit_time">
							</td>
						</tr>
						<tr>
							<td>Department</td>
							<td>
								<select name="department" id="department" style="max-width:155px;">
						...
						<tr>
							...
							<td>
								<?php echo "<input type=\"text\" name=\"hosp_file_no\" style='text-transform:uppercase' value=\"" . $record['hosp_file_no'] . "\">";?>
							</td>
							<td>Past History</td>
						...
						<tr>
							<td>Unit</td>	
							<td>
								<select name="unit" id="unit" style="min-width:155px;">
							...
							<td>Area</td>
							<td>
								<select name="area" id="area" style="min-width:155px;">
									<option selected="selected" value="">--Select--</option>
									<?php
						...
						<tr>
							...
							<td>Pulse Rate</td>
							<td><input type="text" name="pulse_rate" style='text-transform:capitalize'></td>
						</tr>
						<tr>
							<td>Respiratory Rate</td>
							<td><input type="text" name="respiratory_rate" style='text-transform:capitalize'></td>
							<td>Temperature</td>
						...
						<tbody id="mlc_y" hidden>
							<tr>
								...
								<td>PS Name</td>
								<td><input type="text" name="ps_name" id="ps_name" style='text-transform:capitalize'></td>
							</tr>
						</tbody>
					</table>
				</div>
	...
	<tr><td colspan='2' align='center'><input type="submit" id="sub_pt" name="sub" value="Submit"></td></tr>
</table>
</form>
