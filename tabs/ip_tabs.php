...
<form name="reg" action="registration_ip.php" onsubmit="return validateForm_ip();" method="post">
<table>
	<tr><td></td><td>
		<table width="100%">
			<tr>
	...
	<tr>
		<td style="position: relative; vertical-align:top; padding-right:0; padding-top:20px;">
			<table>
				<tr><td><input type="button" id="button_1" value="Patient Info" onclick="reveal('div_1','button_1');" style="position:relative; width:104%; background:#febbbb"></td></tr>
		...
		<td style=" position: relative;vertical-align:top; padding-left:-10px;">
			<fieldset style="width:750px; height:300px; overflow: auto; border: solid 1px;">
				...
				<div id="div_3" style="display:none;" >
					<table width="100%" id="table-tab">
						...
						<tr>
							...
							<td><input type="text" name="hosp_file_no" style='text-transform:capitalize'></td>
							<td>Past History</td>
